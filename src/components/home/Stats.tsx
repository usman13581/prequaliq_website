import { stats, oracleSection } from "@/lib/site-data";
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-white mb-8">
            {oracleSection.trustedUser.headline}
          </h2>
          <div className="inline-flex items-center gap-4 bg-white/5 rounded-2xl px-6 py-4 border border-white/10">
            ...
            <div className="text-left">
              <p className="font-semibold text-white">{oracleSection.trustedUser.name}</p>
              <p className="text-sm text-slate-400">{oracleSection.trustedUser.company}</p>
            </div>
          </div>
        </div>
      </div>
