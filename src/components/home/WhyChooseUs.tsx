        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {t.home.whyChooseUs.items.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="h-12 w-12 rounded-2xl bg-accent-subtle text-accent flex items-center justify-center mb-6 group-hover:bg-accent group-hover:text-white transition-colors">
