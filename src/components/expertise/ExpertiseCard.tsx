...
export function ExpertiseCard({
  ...
  return (
    <Link
      href={`/expertise/${slug}`}
      className="group card-shine relative bg-card rounded-2xl p-5 sm:p-6 lg:p-7 border border-border hover:border-accent/30 hover:shadow-xl hover:shadow-accent/5 transition-all duration-500 flex flex-col h-full min-h-[200px]"
    >
