  ...
  products: {
    ...
    enterpriseHub: {
      ...
      readyForImplementation: {
        ...
        imageAlt: "Enterprise Hub implementation planning",
      },
      modulesIntro: {
      ...
      pricing: {
        eyebrow: "Pricing",
        title: "Simple plans for every team size",
        description:
          "All public prices are in USD. Start with a free trial on Basic or Standard, or talk to us for a tailored enterprise package.",
        ...
        annualSaveBasic: "Save vs monthly billing",
        annualSaveStandard: "Save vs monthly billing",
        usersLabel: "Users",
        ...
        plans: [
          ...
          },
          {
            ...
            name: "Custom",
            badge: "Enterprise",
            users: "Flexible / negotiated",
            priceLabel: "Contact sales team",
            cta: "contact",
            features: [
      ...
      trial: {
        ...
        description:
          "Try Enterprise Hub with sample company data created automatically. No payment is required for the beta. Login details will be sent to your email address, and the temporary password must be changed at first login.",
        privacyNotice:
          "We use your company and contact details to prepare your trial and provide support.",
        fields: {
          ...
          country: "Country",
          emirate: "Emirate",
          approxUsers: "Approximate team size",
          note: "Note",
        ...
        placeholders: {
          ...
          note: "Anything we should know about your trial?",
        },
        currencyLabel: "Currency: {currency}",
        countriesLoadError: "Country list is unavailable right now. Please try again shortly.",
        ...
        consentSuffix: "and allow us to use your details to prepare the trial.",
        submit: "Start 7-Day Trial",
        submitting: "Preparing trial…",
        successTitle: "Your trial is being prepared",
        successMessage:
          "Your trial is being prepared. Login details will be sent to your email address. You must change the temporary password at first login.",
        errorTitle: "Could not start trial",
